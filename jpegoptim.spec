...
Source0  : https://www.kokkonen.net/tjko/src/jpegoptim-1.5.5.tar.gz
Source1  : https://www.kokkonen.net/tjko/src/jpegoptim-1.5.5.tar.gz.asc
Source2  : 9D08A80CED908D6A.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 9D08A80CED908D6A' gpg.status
%setup -q -n jpegoptim-1.5.5
cd %{_builddir}/jpegoptim-1.5.5
pushd ..
cp -a jpegoptim-1.5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720045651
